...
func DefaultBindings() []Binding {
	return []Binding{
		...
		{Key: "d", Command: "show-diff", Context: "worktree-list"},
		...
		{Key: "Y", Command: "approve-all", Context: "worktree-list"},
		{Key: "N", Command: "reject", Context: "worktree-list"},
		{Key: "K", Command: "kill-shell", Context: "worktree-list"},
		{Key: "l", Command: "focus-right", Context: "worktree-list"},
		{Key: "right", Command: "focus-right", Context: "worktree-list"},
		...
		{Key: "h", Command: "focus-left", Context: "worktree-preview"},
		{Key: "left", Command: "focus-left", Context: "worktree-preview"},
		{Key: "esc", Command: "focus-left", Context: "worktree-preview"},
		{Key: "s", Command: "start-agent", Context: "worktree-preview"},
		{Key: "S", Command: "stop-agent", Context: "worktree-preview"},
		{Key: "y", Command: "approve", Context: "worktree-preview"},
		{Key: "Y", Command: "approve-all", Context: "worktree-preview"},
		{Key: "N", Command: "reject", Context: "worktree-preview"},
		{Key: "v", Command: "toggle-diff-view", Context: "worktree-preview"},
		{Key: "0", Command: "reset-scroll", Context: "worktree-preview"},
